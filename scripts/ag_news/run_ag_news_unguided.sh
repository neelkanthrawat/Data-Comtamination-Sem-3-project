...
#
# Job name
#SBATCH --job-name=ag_news_unguided               # TODO: adjust job name
...
#SBATCH --output="ag_news_unguided_out.txt"        # TODO: adjust standard output log
#SBATCH --error="ag_news_unguided_err.txt"         # TODO: adjust error log
...
python "$SCRIPT" --model "Llama" --task "ag_news" --type "unguided"
