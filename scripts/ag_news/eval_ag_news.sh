...
#
# Job name
#SBATCH --job-name=eval_ag_news             # TODO: adjust job name
...
#SBATCH --output="eval_ag_news_out.txt"        # TODO: adjust standard output log
#SBATCH --error="eval_ag_news_err.txt"         # TODO: adjust error log
