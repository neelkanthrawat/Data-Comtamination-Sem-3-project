...
#
# Job name
#SBATCH --job-name=ag_news_guided               # TODO: adjust job name
...
#SBATCH --output="ag_news_guided_out.txt"        # TODO: adjust standard output log
#SBATCH --error="ag_news_guided_err.txt"         # TODO: adjust error log
...
python "$SCRIPT" --model "Llama" --task "ag_news" --type "guided"
