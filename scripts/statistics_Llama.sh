...
#
# Job name
#SBATCH --job-name=stats_Llama             # TODO: adjust job name
...
#SBATCH --output="stats_Llama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="stats_Llama_err.txt"         # TODO: adjust error log
