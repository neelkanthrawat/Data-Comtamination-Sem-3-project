...
#
# Job name
#SBATCH --job-name=statistics_openllama-instruct               # TODO: adjust job name
...
#SBATCH --output="statistics_openllama-instruct_out.txt"        # TODO: adjust standard output log
#SBATCH --error="statistics_openllama-instruct_err.txt"         # TODO: adjust error log
