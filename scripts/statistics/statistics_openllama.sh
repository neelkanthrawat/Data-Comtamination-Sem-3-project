...
#
# Job name
#SBATCH --job-name=statistics_openllama               # TODO: adjust job name
...
#SBATCH --output="statistics_openllama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="statistics_openllama_err.txt"         # TODO: adjust error log
