...
#
# Job name
#SBATCH --job-name=statistics_llama-instruct               # TODO: adjust job name
...
#SBATCH --output="statistics_llama-instruct_out.txt"        # TODO: adjust standard output log
#SBATCH --error="statistics_llama-instruct_err.txt"         # TODO: adjust error log
