...
#
# Job name
#SBATCH --job-name=statistics_llama               # TODO: adjust job name
...
#SBATCH --output="statistics_llama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="statistics_llama_err.txt"         # TODO: adjust error log
