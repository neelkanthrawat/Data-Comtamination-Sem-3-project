...
#
# Job name
#SBATCH --job-name=imdb_unguided               # TODO: adjust job name
...
#SBATCH --output="imdb_unguided_out.txt"        # TODO: adjust standard output log
#SBATCH --error="imdb_unguided_err.txt"         # TODO: adjust error log
...
python "$SCRIPT" --model "Llama" --task "imdb" --type "unguided"
