...
#
# Job name
#SBATCH --job-name=eval_llama-instruct               # TODO: adjust job name
...
#SBATCH --output="eval_llama-instruct_out.txt"        # TODO: adjust standard output log
#SBATCH --error="eval_llama-instruct_err.txt"         # TODO: adjust error log
