...
#
# Job name
#SBATCH --job-name=eval_llama               # TODO: adjust job name
...
#SBATCH --output="eval_llama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="eval_llama_err.txt"         # TODO: adjust error log
