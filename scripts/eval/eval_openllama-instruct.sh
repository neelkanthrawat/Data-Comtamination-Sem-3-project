...
#
# Job name
#SBATCH --job-name=eval_openllama-instruct               # TODO: adjust job name
...
#SBATCH --output="eval_openllama-instruct_out.txt"        # TODO: adjust standard output log
#SBATCH --error="eval_openllama-instruct_err.txt"         # TODO: adjust error log
