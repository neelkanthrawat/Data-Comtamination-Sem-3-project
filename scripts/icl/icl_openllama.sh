...
#
# Job name
#SBATCH --job-name=icl_openllama               # TODO: adjust job name
...
#SBATCH --output="icl_openllama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="icl_openllama_err.txt"         # TODO: adjust error log
