...
#
# Job name
#SBATCH --job-name=icl_openllama-instruct               # TODO: adjust job name
...
#SBATCH --output="icl_openllama-instruct_out.txt"        # TODO: adjust standard output log
#SBATCH --error="icl_openllama-instruct_err.txt"         # TODO: adjust error log
