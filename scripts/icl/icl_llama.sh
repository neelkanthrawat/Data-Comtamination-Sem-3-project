...
#
# Job name
#SBATCH --job-name=icl_llama               # TODO: adjust job name
...
#SBATCH --output="icl_llama_out.txt"        # TODO: adjust standard output log
#SBATCH --error="icl_llama_err.txt"         # TODO: adjust error log
