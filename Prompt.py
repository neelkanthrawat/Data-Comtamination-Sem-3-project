class Prompt:
    ...
    def __init__(self):
        ...
        self.unguided_prompts = {
            ...
            Ensure that the generated sentence aligns with the specified LABEL type. ONLY generate the pausible HYPOTHESIS and nothing else. DO NOT COPY the premise!!
            ### PREMISE: {first_piece}
            ### LABEL: {label}
            ### HYPOTHESIS: 
            """,
